...
public class TechnicalExceptionResponseBuilder implements ResponseBuilder {
    ...
    public void build(HttpServletRequest request, HttpServletResponse response, String message) {
        ...
        response.getWriter().write(
                xmlObjectMapper.writeValueAsString(new ServiceResponse().setResultCode(ServiceResponse.ResultCode.TECHNICAL_ERROR))
        );
    }
}

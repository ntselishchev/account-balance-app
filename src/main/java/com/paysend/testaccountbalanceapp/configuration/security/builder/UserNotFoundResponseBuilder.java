...
public class UserNotFoundResponseBuilder implements ResponseBuilder {
    ...
    public void build(HttpServletRequest request, HttpServletResponse response, String message) {
        ...
        response.getWriter().write(
                xmlObjectMapper.writeValueAsString(new ServiceResponse().setResultCode(ServiceResponse.ResultCode.USER_NOT_FOUND))
        );
    }
}
